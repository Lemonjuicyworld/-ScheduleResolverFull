...
import 'package:schedule_resolver/provider/schedule_provider.dart';
          ...
          children: [
            ...
            if (aiService.errorMessage != null)
              Padding(
                ...
                child: Text(aiService.errorMessage!, style: const TextStyle(color: Colors.red)),
              ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    child: ListTile(
                      ...
                      subtitle: Text("${task.category} | ${task.startTime.format(context)}"),
                      trailing: IconButton(
